# In diesem Skript werden Offsetfehler bezüglich der Magnetfeld-
# sensorpostion simuliert.
# Wird für Bild 3-3 verwendet.
    ...
    for l in range(num_iter_outer):
        ...
        for m in range(len(num_mag_sens)):
            ...
            for j in range(num_iter_inner):
                currents = sf.calc_curr_segments(p.ltr_segs_arr, s.sens_arr, rms[m], resolution, 0.5e-3)
