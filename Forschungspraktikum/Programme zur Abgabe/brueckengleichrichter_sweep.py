...
# Dieses Skript simuliert die Brückengleichrichtung, wobei die
# Diode sowie die Parameter R_L, R_in und V_in variiert werden.
# Es werden die Effizienzen der Schaltung pro Parametersatz
# ermittelt und die 4 besten Dioden in einer .csv-Datei gespeichert
#
# Eingabedaten:
#   - diodes: dict mit Dioden und Parametern
#   - R_L_vec: Lastwiderstände hinter dem Gleichrichter
#   - R_in_vec: Innenwiderstände (der Spannungsquelle)
#   - V_in_vec: Amplituden der Spannungsquelle
#   - freq: Frequenz der Spannungsquelle
#
# Ausgabedaten:
#   - .csv mit den besten 4 Dioden pro Parametersatz
