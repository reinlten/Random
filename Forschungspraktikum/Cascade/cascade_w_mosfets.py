...
circuit.C(2, 'out', circuit.gnd, c_value @ u_F)
circuit.C(3, 2, 'in', c_value @ u_F)
circuit.C(4, circuit.gnd, 1, c_value @ u_F)
circuit.MOSFET("MOS1", circuit.gnd, 3, 3, 3, model=mos)
circuit.MOSFET("MOS2", 3, 1, 1, 1, model=mos)
circuit.MOSFET("MOS3", 1, 2, 2, 2, model=mos)
circuit.MOSFET("MOS4", 2, 'out', 'out', 'out', model=mos)
